...
export default function DrinksBuilder({ comboId, comboGroupId }: { comboId?: string; comboGroupId?: string }) {
    ...
    return <main className="dev-catalog-page">
        ...
        {comboId ? <p className="dev-data-note">This drink will complete your Build Your Own Adventure Combo. Combo pricing is coming soon.</p> : null}
        <div className="dev-drink-order-grid">
            <section className="dev-builder-step"><span className="dev-section-kicker">Fountain drink</span><h2>Choose a Base</h2><p>Standalone fountain pricing has not been finalized. You may preserve the selection in this prototype, but no fake price is shown.</p>
            ...
            <section className="dev-builder-step"><span className="dev-section-kicker">Straight can</span><h2>Energy Drink</h2><p>A sealed Red Bull or Monster can—not a Potion or energy add-in.</p>
